      ...
      <div className="main-padding py-28">
        <div className="mx-16 bg-white/50 backdrop-blur-md rounded-xl md:px-32 sm:px-14 px-5 pb-32">
          ...
          <p>
            ...
            currently allow for sophisticated techniques to be used to enhance
            2D astronomical images to make video representations called
            ...
            perceptual path that can help us understand and appreciate the
